...
import pe.edu.pucp.morapack.web.dto.tabu.TabuSimulationResponse;
import pe.edu.pucp.morapack.web.dto.tabu.ItinerarioDTO;
import pe.edu.pucp.morapack.web.dto.tabu.TabuSearchMeta;
...
public class TabuSimulationService {
    ...
    public synchronized boolean startSimulation(long seed, long snapshotMs) {
        ...
        var airports = loader.loadAirports();
        var flights = loader.loadFlights(airports);
        var orders = loader.loadOrders(airports);
        ...
        init.itinerarios = new pe.edu.pucp.morapack.web.dto.tabu.ItinerarioDTO[0];
        if (messaging != null) {
