...
public class PlannerAirport {
    ...
    public PlannerAirport(int id, String code, String name, String city, Country country, int capacity, int gmt) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.city = city;
    ...
    public PlannerAirport(int id, String code, String name, String city, Country country, int capacity, int gmt, double latitude, double longitude) {
